    ...
    <div className="min-h-screen grid lg:grid-cols-12 bg-[#fafaf9] font-sans" id="tenant-signup-page">
        ...
        <div className="space-y-6 my-auto max-w-sm w-full mx-auto py-10">
          ...
          <form onSubmit={handleSignupSubmit} className="space-y-4 text-xs font-semibold">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. Royal Blades Barber Co."
                  value={shopName}
            ...
            <div>
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[10px] font-mono text-neutral-400">shop/</span>
                <input
                  type="text"
                  placeholder="royal-blades"
                  value={subdomain}
                  onChange={(e) => setSubdomain(e.target.value)}
                  className="w-full bg-[#fafaf9] border border-neutral-300 rounded pl-12 pr-3 py-2.5 focus:outline-none focus:ring-1 focus:ring-[#d4a574] font-medium font-mono"
                  id="signup-slug"
                />
              </div>
              <p className="text-[10px] text-neutral-400 mt-1">Leave blank to auto-generate from shop name.</p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">
                  Owner Name <span className="text-amber-600">*</span>
                </label>
                <div className="relative">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#fafaf9] border border-neutral-300 rounded pl-9 pr-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#d4a574] font-medium font-mono"
                    id="signup-email"
                  />
                </div>
              </div>
            ...
            <div>
              <label className="text-[10px] uppercase tracking-widest text-neutral-400 block mb-1">
                Set Password <span className="text-amber-600">*</span>
              </label>
              <div className="relative">
          ...
          <div className="text-center space-y-2 pt-2">
            <div>
              <span className="text-[10px] text-neutral-400">Already have a shop? </span>
      ...
      <div className="hidden lg:flex lg:col-span-7 bg-[#1a1a1a] relative items-center justify-center p-12 overflow-hidden border-l border-[#8b7355]/30">
        <div className="absolute inset-0 opacity-15">
          ...
          <img src="https://picsum.photos/seed/barbershop/1200/900" alt="Barber Shop" className="w-full h-full object-cover" />
        </div>
